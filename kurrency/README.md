...
[![Reposilite](https://repo.aquatic.gg/api/badge/latest/releases/gg/aquatic/kurrency?color=40c14a&name=Reposilite)](https://repo.aquatic.gg/#/releases/gg/aquatic/kurrency)
...
dependencies {
    implementation("gg.aquatic:kurrency:26.0.54")
}
```
